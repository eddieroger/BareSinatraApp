...
%w{ sinatra/base sinatra/content_for sinatra/config_file sinatra/respond_with rack-flash rack/contrib rack/csrf warden data_mapper dm-serializer dm-types base64 zlib redis securerandom singleton}.each {|req| require req }
