...
%w{ sinatra/base sinatra/content_for sinatra/config_file sinatra/respond_with rack-flash rack/contrib rack/csrf warden data_mapper dm-serializer base64 openssl}.each {|req| require req }
