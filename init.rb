...
%w{ sinatra/base sinatra/content_for sinatra/config_file sinatra/respond_with sinatra/activerecord rack-flash rack/contrib rack/csrf warden securerandom open-uri json bcrypt}.each {|req| require req }
